         ...
         <section class="mt-8">
            <div class="container">
               <div class="hero-slider">
                  <div style="background: url(./assets/images/slider/grey.jpg) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                     <div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
                        <span class="badge text-bg-warning">배너 작은 설명 들어갈 곳</span>
                        <h2 class="text-dark display-5 fw-bold mt-4">배너 들어갈 곳 ㅁㄴㅇㄻㅇㄻㄴㄹㅇ</h2>
                        <p class="lead">배너에 대한 자세한 설명이 들어갈 곳입니다. ㅁㅁㅁㅁㅁㅁㅁㅁㅁ</p>
                  ...
                  <div style="background: url(./assets/images/slider/grey.jpg) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                     <div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
                        <span class="badge text-bg-warning">배너 작은 설명 들어갈 곳</span>
                        <h2 class="text-dark display-5 fw-bold mt-4">2배너 들어갈 곳 ㅁㄴㅇㄻㅇㄻㄴㄹㅇ</h2>
                        <p class="lead">배너에 대한 자세한 설명이 들어갈 곳입니다. ㅁㅁㅁㅁㅁㅁㅁㅁㅁ</p>
                        <a href="#!" class="btn btn-dark mt-3">
                           링크이동버튼
                           <i class="feather-icon icon-arrow-right ms-1"></i>
                  ...
                  <div style="background: url(./assets/images/slider/grey.jpg) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                     <div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
                        <span class="badge text-bg-warning">배너 작은 설명 들어갈 곳</span>
                        <h2 class="text-dark display-5 fw-bold mt-4">3배너 들어갈 곳 ㅁㄴㅇㄻㅇㄻㄴㄹㅇ</h2>
                        <p class="lead">배너에 대한 자세한 설명이 들어갈 곳입니다. ㅁㅁㅁㅁㅁㅁㅁㅁㅁ</p>
                        <a href="#!" class="btn btn-dark mt-3">
                           링크이동버튼
                           <i class="feather-icon icon-arrow-right ms-1"></i>
                     ...
                     <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                        <div class="card card-product mb-lg-4">
                           <div class="card-body text-center py-8">
                              ...
                              <div class="text-truncate">추천 상품</div>
                           </div>
                        </div>
                     </a>
                  </div>
